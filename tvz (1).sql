...
--
-- Servidor: bjb5de3zoi98bnkzpitc-mysql.services.clever-cloud.com:3306
-- Tiempo de generación: 13-03-2025 a las 12:36:12
...
--
-- Base de datos: `bjb5de3zoi98bnkzpitc`
--
...
CREATE TABLE `direccion` (
  ...
  `ID_provincia` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `numero` int(11) NOT NULL,
  `ID_usuario` int(11) NOT NULL,
  `ID_localidad` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
...
INSERT INTO `direccion` (`ID_direccion`, `calle`, `ID_provincia`, `numero`, `ID_usuario`, `ID_localidad`) VALUES
(18, 'Peñaloza ', '7', 1927, 75, '794');
...
CREATE TABLE `skate` (
  ...
  `apodo` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `velocidad` tinyint(4) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `skate`
--

INSERT INTO `skate` (`codigo`, `apodo`, `velocidad`, `bateria`, `temperatura`, `longitud`, `latitud`, `hora`, `vendido`, `ID_modelo`, `ID_usuario`) VALUES
('YYYYY1', 'Erie', 6, 90, 26.4, '-64.12756', '-32.17393', '16:06:28', 0, 0, 75),
('YYYYY2', 'Zerbi', 12, 12, 12, '1', '', '00:00:00', 0, 0, NULL);
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `reset_token`, `reset_expiration`) VALUES
(49, 'santi', 'santizerbini3@gmail.com', '$2y$10$.DzykEPstzqZTGh4YwrId.FjqryiztBVHUE9mQEi33zpIPc47dkM.', '54ba944151296ce79a01f2b2d5d5e409bc39bc97eabaffebe3380576f1f5e80c12f9b13900f2a30c8109c541bb4009ef1583', '2024-09-10 21:52:29'),
(75, 'Erie', 'venturinierie@gmail.com', '$2y$10$u2qXc7IONHGZ7V1TqK35/.sT9x/BHRw3xgHWmLSPM.FW5.3WwK/nq', NULL, NULL),
(77, 'Leonardo', 'leonardogottero@alumnos.itr3.edu.ar', '$2y$10$S8qqmauHjVUhodS4VlggtuA/RL1ZmbDlSwr3x7ivyrbui.VzuEm9W', NULL, NULL),
(78, 'juanmarqquez', 'juanmarquez@alumnos.itr3.edu.ar', '$2y$10$4NX1KAVR2wUYMqSZkoq4peQNs.qx7u9ewxeGfx5AWBW2nrYhLsJse', NULL, NULL),
(79, 'franciscotest', 'rissonefran@gmail.com', '$2y$10$92nuP9ZejVVLuYcerF3Q2e432/GGYnK6MWPzGSRIXgiyU6Z3.X.NW', NULL, NULL);
