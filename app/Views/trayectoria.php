...
$codigo = 'YYYYY1'; // Asumo que este código es un placeholder, lo mantengo.
...
<head>
    ...
    <style>
        ...
        @import url('https://fonts.googleapis.com/css2?family=Baskervville+SC&display=swap'); /* Añadido Baskervville SC */
        ...
        .header h1 {
            font-size: 1.5rem;
            font-family: "Baskervville SC", static; /* Mantengo este font-family para el h1 */
            margin: 0;
...
<div class="header" id="mainHeader">
    <h1>Trayectoria del Skate</h1> <div class="menu-icon" id="menuIcon">
