...
<script>
  ...
  // El botón de instalar PWA no está en esta vista, así que el listener se puede quitar
  ...
  // El timeout tampoco es necesario si el botón no está presente
  // setTimeout(() => {
  //   if (!installEvent) {
  //     // document.getElementById('installButton').style.display = 'inline-block'; // Quitar o adaptar
  //   }
  // }, 3000);
</script>
</body>
