...
<head>
    ...
    <title>Restablecer Contraseña | E-Skate</title>
    ...
    <style>
        ...
        .reset-form button[type="submit"]::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        .reset-form button[type="submit"]:hover::before {
            width: 100%;
        }
...
<body>
    <div class="reset-form">
        ...
        <div class="reset-links">
            <a href="<?= site_url('login') ?>">Volver a iniciar sesión</a>
        </div>
    </div>
</body>
</html>